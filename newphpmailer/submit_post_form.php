...
$message .= '<table cellspacing="0" cellpadding="0" border="0" align="center" width="100%">
			...
			$message .= '<a href="superknit.com/tempimg/'.strtotime('now')."".$file_name.'">Get Resume</a>';
$message .= '</body></html>';
//End Html Page Here
...
$mail->Username = 'gaurav@togglehead.in';	// SMTP username
...
$mail->Subject = 'Email From Superknit Website - Career Form';
$mail->Body    = $message;
